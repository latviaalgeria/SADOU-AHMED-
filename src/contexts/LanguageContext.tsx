...
const translations = {
  ...
  ar: {
    ...
    "hero.description": "نرافق الفلاحين الجزائريين بالمشورة الفنية المخصصة والمتابعة الميدانية والمنتجات العالية الجودة",
    "hero.cta": "اتصل بنا",
    
    // Services
    "services.title": "خدماتنا",
    "services.subtitle": "في EURL Phyto Safety، لا نكتفي ببيع المنتجات - نحن نبني شراكات فنية مستدامة مع الفلاحين. يعتمد نهجنا على ثلاث خطوات رئيسية: التشخيص والمرافقة ثم الحل بالمنتج المناسب.",
    "services.card1.title": "استشارات ودعم فني مخصص",
    "services.card1.description": "تحت إشراف المهندس سعادو أحمد، يرافق فريقنا الفلاحين طوال موسمهم الزراعي، من تحليل الاحتياجات إلى تنفيذ بروتوكولات العلاج، مع المتابعة الميدانية والمشورة الزراعية المكيفة مع الواقع المحلي.",
    "services.card2.title": "التشخيص والتوصيات محددة",
    ...
    "services.card3.description": "بمجرد اكتمال التشخيص، نقدم لك الحلول الأنسب لاحتياجاتك. تشمل مجموعتنا منتجات أصلية عالية الجودة من شركات عالمية كبرى مثل BAYER، SYNGENTA، CORTIVA، BASF، FMC. نتعاون أيضًا مع موردين معروفين مثل PROFERT، CASAP، SRID، AGRICHEM وغيرهم. كموزع مباشر، نضمن أسعارًا تنافسية ومخزونًا مختارًا بعناية لتلبية متطلبات الفلاحين العصريين.",
