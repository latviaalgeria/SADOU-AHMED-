...
const translations = {
  ...
  ar: {
    ...
    "services.card1.description": "تحت إشراف المهندس سعادو أحمد، يرافق فريقنا المزارعين طوال موسمهم الزراعي، من تحليل الاحتياجات إلى تنفيذ بروتوكولات العلاج، مع المتابعة الميدانية والمشورة الزراعية المكيفة مع الواقع المحلي.",
