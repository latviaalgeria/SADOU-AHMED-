...
const translations = {
  ...
  ar: {
    ...
    // Hero
    'hero.title': 'الكفاءة والخبرة والحلول للزراعة الحديثة',
    'hero.description': 'نرافق المزارعين الجزائريين بالمشورة الفنية المخصصة والمتابعة الميدانية والمنتجات عالية الجودة',
    'hero.cta': 'اتصل بنا',
